 ...
 * Loads the mod pool + prices, checks feasibility, selects applicable solver
 * strategies, and writes the resolved {pool,prices,target} blob to S3 scratch.
 *
...
import { enumerateStrategies } from "../shared/strategies/StrategyRegistry";
